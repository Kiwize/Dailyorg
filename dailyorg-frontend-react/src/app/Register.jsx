    ...
    return (
        <Box sx={{ mx: { xs: "10%", md: "35%" }, pt: 8, textAlign: 'center' }}>
            <Paper elevation={3} sx={{ p: 4 }}>
                <Typography variant="h4" sx={{ textAlign: 'center', marginBottom: "10px" }}>Register</Typography>
                <form onSubmit={handleRegister}>
                    ...
                    <div style={{ color: "red", marginTop: "10px", padding: "10px", backgroundColor: "rgba(255, 0, 0, 0.1)", borderRadius: "5px", display: error !== "" ? "block" : "none" }}>
                        {error !== "" && error}
                    </div>
                </form>
            </Paper>
